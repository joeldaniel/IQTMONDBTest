...
public class IQMN_JM_JN extends Testbase {
	@Test
	public static void Testing() throws ClassNotFoundException, SQLException {
		test = extent.createTest("JobSpec Material Validation");
		...
		try {
			...
			Object obj = new JSONParser().parse(
					new FileReader(System.getProperty("user.dir") + "\\src\\test\\resources\\properties\\JobSpecMaterial.json"));
