...
public class IQMN_JS_JN extends Testbase {
	@Test
	public static void Testing() throws ClassNotFoundException, SQLException {
		test = extent.createTest("JobSpec Operation Validation");
		...
		try {
			...
			Object obj = new JSONParser().parse(
					new FileReader(System.getProperty("user.dir") + "\\src\\test\\resources\\properties\\JobSpecOperation.json"));
